...
```{r}
new_session <- full_join(actions, devices, by = "user_id")
```

### Join with user_train
```{r}
airbnb_train <- left_join(users_train, new_session, by = c("id" = "user_id"))
```


```{r message=FALSE}
airbnb_train %>% ggplot(aes(x = Apple)) + geom_histogram()
airbnb_train %>%  ggplot(aes(x = (Apple^(1/3)))) + geom_histogram()

airbnb_train %>% ggplot(aes(x = Android)) + geom_histogram()
# airbnb_train %>% ggplot(aes(x = log(Android))) + geom_histogram()
airbnb_train %>% ggplot(aes(x = (Android^(1/3)))) + geom_histogram()

airbnb_train %>% ggplot(aes(x = Windows)) + geom_histogram()
# airbnb_train %>% ggplot(aes(x = log(Windows))) + geom_histogram()
airbnb_train %>% ggplot(aes(x = (Windows^(1/3)))) + geom_histogram()

airbnb_train %>% ggplot(aes(x = Other)) + geom_histogram()
airbnb_train %>% ggplot(aes(x = log(Other))) + geom_histogram() # bimodal distribution -> binning
# airbnb_train %>% filter(Other != 0) %>% ggplot(aes(x = (Other^(1/3)))) + geom_histogram()
...
device_trans <- device_trans %>% mutate(AppleCate = cut(cbrt_Apple, cbrt_AppleBreaks),
                                        AppleCate = cut(cbrt_Android, cbrt_AndroidBreaks),
                                        AppleCate = cut(cbrt_Windows, cbrt_WindowsBreaks)) %>% 
