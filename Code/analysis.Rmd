...
# since it's far beyond acceptable proportion of missing value in terms of age and gender, I think a complete case analysis is more reasonable than imputed data anlaysis
df_cc <- df %>% 
...
first_browser_drop <- unique(df_cc %>%
